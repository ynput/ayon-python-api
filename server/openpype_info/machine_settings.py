"""Information about this machine related to OpenPype.

Getters related to local settings and local id. Classes giving ability to
store or receive machine data (e.g. using keyring).
"""
...
class IniSettingRegistry(ASettingRegistry):
    ...
    def _delete_item(self, name):
        ...
        Note:
            See :meth:`~IniSettingsRegistry.delete_item_from_section`
        """
...
class JSONSettingRegistry(ASettingRegistry):
    ...
    def _set_item(self, name, value):
        ...
        Note:
            See :meth:`JSONSettingRegistry.set_item`
        """
