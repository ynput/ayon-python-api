"""Interfaces to show 'what must be implemented' on module to do 'something'.

For example that module has plugins that can be registered etc.
"""
...
class ITrayService(ITrayModule):
    ...
    def _load_service_icons():
        ...
        # QUSETION will these resources be on client side?
